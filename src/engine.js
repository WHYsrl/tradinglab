...
- Ordini ancora disponibili oggi: ${ctx.remainingOrders} (max ${settings.maxOrdersPerSession()} per sessione): opera solo dove hai una tesi, non per riempire il budget
