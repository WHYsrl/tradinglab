...
4. Da quel momento profilo di rischio, trading on/off, modelli, cadenza delle review **e il bacino di azioni** (aggiunta/rimozione ticker, validati su Alpaca, max 30) si regolano **dalla dashboard** (card Impostazioni): salvate nel DB persistente, effetto immediato senza riavvio. Le variabili d'ambiente restano solo come default iniziali.
